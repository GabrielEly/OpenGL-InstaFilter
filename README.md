...
Propriedades > C/C++ > Geral > Diretórios de Inclusão Adicionais > ... Adiciocione os diretórios `GLEW/include`, `GLFW/include` e `/glm` da pasta `/dependencies` deste projeto, como mostra a imagem a seguir;
...
Código usado é C++ juntamente com o OpenGL e GLSL, e as bibliotecas adicionais GLAD, GLFW, GLM.
